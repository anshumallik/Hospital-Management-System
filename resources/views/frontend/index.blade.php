                ...
                <div class="row no-gutters align-items-center pt-60px">
                    <div class="col-5 d-none d-sm-block">
                        <div class="hero-banner__img">
                            <img class="img-fluid" src="{{asset('images/35-512.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
                        <div class="hero-banner__content">
                            <h1>Birat Eye Hopital</h1>
                            <h4>Twenty-four Hour Service</h4>
                            <p>Us which over of signs divide dominion deep fill bring they're meat beho upon own earth
                                ...
                                grass.</p>
                            <a class="button button-hero" href="{{route('frontend.register')}}">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="offer__content text-center">
                            <h3>Up To 50% Off</h3>
                            <h4>Eye Checkup</h4>
                            <a class="button button--active mt-3 mt-xl-4" href="#">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        <div class="card card-blog">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-blog__title"><a href="single-blog.blade.php">The Richland Center
                                        Shooping
                                        News
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        <div class="card card-blog">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-blog__title"><a href="single-blog.blade.php">The Shopping News also
                                        offers
                    ...
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        <div class="card card-blog">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-blog__title"><a href="single-blog.blade.php">Professional design staff
                                        and
