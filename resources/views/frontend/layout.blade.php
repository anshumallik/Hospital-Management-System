...
<head>
    ...
    <title>Birat Eye Hospital</title>
    <link rel="icon" href="{{asset('images/35-512.png')}}" type="image/png">
...
<header class="header_area">
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand logo_h" href="index.blade.php"><img src="{{asset('img/logo.png')}}" alt=""></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                                        href="{{route('frontend.register')}}">Register</a></li>
                            </ul>
                        </li>
                        <li class="nav-item submenu dropdown">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{route('frontend.login')}}">Login</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                                        href="{{route('frontend.register')}}">Register</a></li>
                ...
                <div class="offset-lg-1 col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget tp_widgets">
                        ...
                        <div class="ml-40">
                            ...
                            <p>123, Main Street, Biratnagar</p>
